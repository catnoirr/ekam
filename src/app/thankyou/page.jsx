    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        <div className="bg-white shadow-sm rounded-xl p-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              We appreciate your interest in WeMee Corporate Gifting Company.<br />
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <a href="tel:+917498527215" 
                ...
                <span className="ml-3 text-gray-600 group-hover:text-blue-600">+91 74985 27215</span>
              </a>
              <a href="tel:+918668365538" 
                className="flex items-center p-4 rounded-lg border border-gray-100 hover:border-blue-100 hover:bg-blue-50 transition-colors group">
                <svg className="w-5 h-5 text-gray-400 group-hover:text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
                    d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="ml-3 text-gray-600 group-hover:text-blue-600">+91 86683 65538</span>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="https://wa.me/+917498527215"
        ...
        <footer className="mt-8 text-center text-sm text-gray-500">
          © {new Date().getFullYear()} WeMee Corporate Gifting. All rights reserved.
        </footer>
      </main>

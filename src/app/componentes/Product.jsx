    ...
    return (
        <>
            <div className="text-center mt-10">
                    ...
                    <div className="w-3/5 h-0.5 bg-teal-600 mx-auto mt-2 rounded-full"></div>
                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {products.map((product) => (
                            <Link 
                                ...
                                className="group relative bg-white rounded-3xl border border-[#c9f2fc] overflow-hidden shadow-[0_0_15px_rgba(201,242,252,0.3)] hover:shadow-[0_0_20px_rgba(157,237,255,0.5)] transition-all duration-300 transform hover:-translate-y-1"
                            >
